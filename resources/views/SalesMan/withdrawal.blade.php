              ...
              <div class="panel-body">
                {!! Form::open(['action' => ['MemberController@withdrawalrequest',$user->id], 'method' => 'POST']) !!}
                  <div class="wdalbox">
                    ...
                    <span class="greytitle wd">{{number_format($user->Commision)}}원(수수료수당) + {{number_format($user->RecommenderCommision)}}원(추천인수당) = {{number_format($user->RecommenderCommision + $user->Commision)}} 원</span>
                  </div>
                  <div class="wdalbox">
