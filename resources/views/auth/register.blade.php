                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('Recommender') ? ' has-error' : '' }}">
                            <label for="Recommender" class="col-md-4 control-label">Recommender</label>

                            <div class="col-md-6">
                                <input id="Recommender" type="text" class="form-control" name="Recommender" value="{{ old('Recommender') }}" required autofocus>
